...
function insertImage(body, callback) {
    db.serialize(() => {
        let sql = db.prepare("INSERT INTO Comics (num, month, link, year, transcript, alt, img, title, day, hash) VALUES ($num, $month, $link, $year, $transcript, $alt, $img, $title, $day, $hash)");
